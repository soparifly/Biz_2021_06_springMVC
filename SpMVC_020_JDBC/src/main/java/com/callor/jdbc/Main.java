...
public class Main {
	/*
	 * primitive type의 변수는 함수의 매개변수로 전달하였을때
	 * 함수에서 매개변수의 값을 변경하여도
	 * 호출하기전 원래 변수의값은 변함이 없다
	 * 
	 * type형 변수(Class type의 변수, Class로 생성된 객체변수)는 
	 * 함수에 매개변수로 전달하였을때 
	 * 
	 * 변수의 요소 중 일부를 변경하거나 추가 삭제 하면 원래 함수에 전달하기 전의 변수 값이 변경된다
	 * 
	 */
	public static void main(String[] args) {
		...
		add(userList);
		add(userList);
		System.out.println("add after : "+ userList.toString());
