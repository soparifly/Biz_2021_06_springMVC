 ...
 * 
 * 각각 VO별로 서비스를 생성하기위하여 만드는 것은 조금 낭비가 되기때문에
 * 
 */
public interface NaverService<BookDTO>{
	//검색 문자열을 받아서 검색을 위한 UR을 생성하여 return 
	public String queryURL(String search_text);
	
//	queryURL을 NAVER에 보내고 
//	NAVER가 보낸 데이터를 json형태로 문자열로 만들어 return 
